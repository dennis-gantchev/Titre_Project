<template>
  <section>
    ...
    <div class="request-container">
      <h6 class="title">Demandes en cours</h6>
          ...
          <article class="card">
            <div class="flex flex-col w-full">
              ...
              <div class="card-content">
                ...
                <router-link :to="'/request/show/'+request.id"><button class="button-sky">Voir</button></router-link>
              </div>
            </div>
          </article>
        </span>
...
export default {
  ...
  methods:{
    ...
    async getRequest(){
      const response = await BackendService.get('request/progress', `${this.page}`)
